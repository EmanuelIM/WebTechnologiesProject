    ...
    <div class="main-content">
        ...
        <main>
            ...
            <form action="" method="post" id="login-form" autocomplete="off">
                ...
                <input type="number" step="0.01" id="secondratodds" name="secondratodds" placeholder="Odds..">
                ...
                ?><br>
                <input type="password" id="pass" name="password" placeholder="Super admin password to confirm your match..">
