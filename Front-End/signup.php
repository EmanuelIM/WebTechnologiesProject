		...
		<div class="login-content">
			<form action="" method="post" id="login-form" autocomplete="off">
				...
				<?php  if(isset($error['username'])){
					echo "<div>
							<p style='border: 5px solid red; padding: 10px 0px'>". $error['username']. "</p>
						 </div>";
				}?>
				<div class="input-div one">
					<div class="i">
				...
				<div class="input-div one">
					...
					<div class="div">
						<h5>Country</h5>
						<select name="country" class="input" id="country" autocomplete="on" >
							<option value="">-</option>
				...
				<?php  if(isset($error['email'])){
					echo "<div>
							<p style='border: 5px solid red; padding: 10px 0px'>". $error['email']. "</p>
						 </div>";
				}
				?>
				...
				<?php  if(isset($error['password'])){
					echo "<div>
							<p style='border: 5px solid red; padding: 10px 0px'>". $error['password']. "</p>
						 </div>";
				}
				?>
