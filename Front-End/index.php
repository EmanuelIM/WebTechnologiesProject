                    ...
                    <div class="customers">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="customer">
                                    <div class="info">
                                        <input class="borderOnClick" name="totalElevation" type="text" id="elev" value="0" style="text-align: center;"></input>
                                    </div>
                                    <div class="contact">
                                        <input class="borderOnClick" name="totalMatches" type="text" id="inc" value="0" style="text-align: center;"></input>
                                    </div>
                                </div>
                                <div>
                                    <h2 class="ammount">What are you willing to pay?</h2>
                                    <div>
                                        <input class="borderOnClick alignBtn" name="ticketValue" type="number" id="ticketValue" placeholder="Enter how much money do you want to bet...">
                                    </div>
                                </div>
                                <div style="padding-top: 10px;">
                                    <input class="placeBet" type="button" onclick="calculateMoney()" value="Calculate how much you will make">
                                </div>
                                <div>
